...
async function TestSceneSetup(env, _G){
    if(1==1){return};
...
async function TestSceneUpdate(env, _G){
    const ped = app.GetElementObject("Ped");

    // ped.Position.Add(Udim2.fromScale(.01));
...
async function TestSceneCleanup(env, _G){

}

app.RegisterScene("TestScene", {
    Setup: TestSceneSetup,
    Update: TestSceneUpdate,
    Cleanup: TestSceneCleanup,


    ElementDatas: TestSceneElements,
});